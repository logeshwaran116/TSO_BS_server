...
class BridgitMash(bs.Map):
    ...
    defs = mapdefs
    # Move spawn1 a bit to the right (less negative)
    defs.points['spawn1'] = (-9.5, 0.02275111462, 0.0) + (0.5, 1.0, 4.0)
    # Move spawn2 a bit to the left (less positive)
    defs.points['spawn2'] = (9.3, 0.01092306765, 0.0) + (0.5, 1.0, 4.0)
