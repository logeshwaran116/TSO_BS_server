...
def getlanguage(text, sub: str = ''):
    ...
    translate = {
        ...
        "S: Icy Floor":
            {"Spanish": "Piso resbaladizo",
             "English": "Icy Floor",
             "Portuguese": "Piso escorregadio"},
    }
...
class BasketGame(bs.TeamGameActivity[Player, Team]):
    ...
    available_settings = [
        ...
        bs.BoolSetting(getlanguage('S: Icy Floor'), default=False),
    ...
    def __init__(self, settings: dict):
        ...
        self._icy_floor = bool(settings[getlanguage('S: Icy Floor')])
