        ...
        for char_node, i, mchar, curr_x in self._char_nodes:
            ...
            if anim_id == 1:#blue - pink
                bs.animate_array(
                    ...
                    'color',
                    3,
                    {0.0:(0,0.4,0.85), 0.5:(1,0,0.5), 1.0:(0,0.4,0.85)},
                    loop= True,
                    offset= delay
                )
                ...
                bs.animate_array(
                    ...
                    'color',
                    3,
                    {0.0:(0.2, 1.0, 0.0), 0.5:(0.745, 0.161, 0.925), 1.0:(0.2, 1.0, 0.0)},
                    loop= True,
                    offset= delay
                )
                ...
                bs.animate_array(
                    ...
                    'color',
                    3,
                    {0.0:(1, 0.29, 0.004), 0.25:(0.106, 0.122, 0.42), 0.5:(1, 0.29, 0.004), 1.0:(0.106, 0.122, 0.42)},
                    loop= True,
                    offset= delay
                )
                ...
                bs.animate_array(
                    ...
                    'color',
                    3,
                    {0.0:(1, 0.835, 0), 1.0:(0.271, 0.663, 0.663) },
                    loop= True,
                    offset= delay
                )
                ...
                bs.animate_array(
                    ...
                    'color', 
                    3, 
                    {0.0: (0.05, 0.15, 0.3), 0.5: (0.15, 0.6, 0.75), 1.0: (0.7, 0.95, 0.85)}, 
                    loop=True, 
                    offset=delay
                )
                ...
                bs.animate_array(
                    ...
                    'color', 
                    3, 
                    {0.0: (0.3, 0.1, 0.4), 0.5: (0.8, 0.3, 0.5), 1.0: (1.0, 0.65, 0.55), 1.5: (0.2, 0.6, 0.7)}, 
                    loop=True, 
                    offset=delay
                )
                ...
                bs.animate_array(
                    ...
                    'color', 
                    3, 
                   {0.0: (0.75, 0.15, 0.1), 0.33: (0.0, 0.95, 0.9), 0.66: (0.3, 0.05, 0.1), 1.0: (1.0, 0.8, 0.2)}, 
                    loop=True, 
                    offset=delay
                )
                ...
                bs.animate_array(
                    ...
                    'color', 
                    3, 
                   {0.0: (1.0, 0.2, 0.6), 0.25: (0.1, 0.9, 1.0), 0.5: (0.9, 1.0, 0.2), 0.75: (0.6, 0.0, 1.0), 1.0: (0.0, 1.0, 0.5)}, 
                    loop=True, 
                    offset=delay
                )
                ...
                bs.animate_array(
                    ...
                    'color', 
                    3, 
                   {0.0: (1.0, 0.3, 0.35), 0.33: (0.05, 0.2, 0.15), 0.66: (0.5, 0.2, 0.8), 1.0: (0.95, 0.85, 0.3)}, 
                    loop=True, 
                    offset=delay
                )
                ...
                bs.animate_array(
                    ...
                    'color', 
                    3, 
                   {0.0: (0.25, 0.1, 0.0), 0.25: (0.6, 0.35, 0.05), 0.5: (0.95, 0.7, 0.1), 0.75: (1.0, 0.9, 0.4), 1.0: (1.0, 0.98, 0.85)}, 
                    loop=True, 
                    offset=delay
                )
                bs.animate(char_node, 'rotate', {0.0: -20, 1.0: 20}, loop=True, offset=delay)
                ...
                bs.animate_array(
                    ...
                    'color', 
                    3, 
                    {0.0: (1,0,0), 0.25: (1,1,1), 0.5: (0,0,1), 0.75: (0,0.8,1), 1.0: (1,0,0)}, 
                    loop=True, 
                    offset=delay
                )
                ...
                bs.animate_array(
                    ...
                    'color', 
                    3, 
                    {0.0: (0.0, 0.0, 0.4), 0.25: (0.6, 0.0, 0.6), 0.5: (0.8, 0.6, 0.2), 0.75: (0.0, 0.5, 0.2), 1.0: (0.7, 0.7, 0.9)}, 
                    loop=True, 
                    offset=delay
                )
                bs.animate(char_node, 'rotate', {0.0: 0, 0.125: 7.5, 0.25: 15, 0.375: 7.5, 0.5: 0, 0.625: -7.5, 0.75: -15, 0.875: -7.5, 1.0: 0}, loop=True, offset=delay)
                ...
                bs.animate_array(
                    ...
                    'color', 
                    3, 
                    {0.0: (0.3, 0.0, 0.1), 0.25: (0.85, 0.05, 0.15), 0.5: (1.0, 0.45, 0.0), 0.75: (1.0, 0.8, 0.1), 1.0: (1.0, 0.98, 0.75)}, 
                    loop=True, 
                    offset=delay
                )
                ...
                bs.animate_array(
                    ...
                    'color', 
                    3, 
                    {0.0: (0.0, 0.2, 0.5), 0.25: (0.2, 0.5, 0.7), 0.5: (0.5, 0.0, 0.5), 0.75: (0.1, 0.7, 0.6), 1.0: (0.7, 0.9, 1.0)}, 
                    loop=True, 
                    offset=delay
                )
